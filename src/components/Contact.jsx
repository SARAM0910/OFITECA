  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setTimeout(resetForm, 5000);  // Borra el formulario después de 5 segundos (si lo deseas)
      } else {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow-md text-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                className="w-full bg-[#feb108] text-white py-2 rounded-md hover:bg-yellow-600 transition"
